...
# --- Start App ---
st.title("📊 Afstemning om Budget 2025")
st.write("Afgiv din stemme om godkendelse af budgettet for 2025.")
...
vote = st.radio("Hvad er din holdning til budgettet for 2025?", options)
